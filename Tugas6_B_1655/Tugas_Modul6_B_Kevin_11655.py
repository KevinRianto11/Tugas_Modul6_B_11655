...
model = load_model(r'C:\Users\kevst\OneDrive\Documents\Kuliah\Sem 5\Pembelajaran Mesin dan Pembelajaran Mendalam\Tugas6_X_YYYYY\Tugas6_B_11655\model_mobilenet.h5')
...
def custom_progress_bar(confidence, color1, color2):
    ...
    progress_html = f"""
    <div style="border: ipx solid #ddd; border-radius: 5px; overflow: hidden; width: 100%; font-size: 14px;">
...
st.title("Prediksi Kematangan Buah Naga - 1655")

uploaded_files = st.file_uploader("Unggah Gambar (Lebih dari 1 diperbolehkan)", type=["jpg", "png", "jpeg"], accept_multiple_files=True)
